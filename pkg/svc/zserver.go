...
//
// TODO: Extend the GithubReleaseNotes service by defining new RPCs and
...
//
// TODO: Create an implementation of the GithubReleaseNotes server
...
// implementation of GithubReleaseNotes server interface service, but only
...
// Default implementation of the GithubReleaseNotes server interface
type server struct{}
...
func NewBasicServer() (pb.GithubReleaseNotesServer, error) {
	return &server{}, nil
}
