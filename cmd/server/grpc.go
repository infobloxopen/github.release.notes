...
import (
	...
	"github.com/infobloxopen/github.release.notes/pkg/pb"
	"github.com/infobloxopen/github.release.notes/pkg/svc"
...
func NewGRPCServer(logger *logrus.Logger) (*grpc.Server, error) {
	...
	pb.RegisterGithubReleaseNotesServer(grpcServer, s)
